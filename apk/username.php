...
<div id="appCapsule">
    ...
    <div class="listview-title mt-1">Update Username</div>
        ...
        <form action="#" method="post">
            <div class="card" style="border-radius: 8px 8px 0 0" >
                <div class="card-body pb-1">
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            <input type="email" class="form-control" id="email1" placeholder="Current Username" name="username" value="<?php echo 'coder'?>" readonly>
                ...
                <div class="card-body pb-1">
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            <input type="password" class="form-control" id="pwd" placeholder="New Username" name="n_username">
                            <i class="clear-input"><ion-icon name="close-circle"></ion-icon></i>
                        </div>
                    </div>
                </div>
