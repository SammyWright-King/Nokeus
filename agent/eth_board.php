							...
							<div class="wallet-footer" style="padding:0" >
								...
								<div class="item">
									<select id="BuyCoin" style="font-size:13pt;color:#fff;padding:10px;width:100%;border-radius: 5px;border:none;box-shadow: 1px 1px 10px #D3D3D3" class="bg-info currency" onchange="location = this.value;" > 
											...
											<option> RMB </option>
											<option value="home.php?usdt" > USDT </option>
									</select>
								</div>
							 ...
							 <form>
								...
								<div class="form-group basic" style="width:50%;float:left" >
									<div class="input-group mb-1" >
										<input type="number" id="BuybitUSD" class="form-control" placeholder="NGN/ethUSD" onchange="calculate();"  onkeypress="this.onchange();" onpaste="this.onchange();" oninput="this.onchange();" >
									</div>
								</div>
								<div class="form-group basic" style="width:50%;float:left" >
									<div class="input-group mb-1">
										<input type="number"  id="BuyBTC" class="form-control" placeholder="NGN/ETH" onchange="calculate();"  onkeypress="this.onchange();" onpaste="this.onchange();" oninput="this.onchange();" >
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="cards2" role="tabpanel" style="text-align:center" >
							...
							<br>
							 ...
							 <form>
								...
								<div class="form-group basic" style="width:50%;float:left" >
									<div class="input-group mb-1" >
										<input type="number" id="SellbitUSD" class="form-control" placeholder="Sell" placeholder="NGN/ethUSD" >
									</div>
								</div>
								<div class="form-group basic" style="width:50%;float:left" >
									<div class="input-group mb-1">
										<input type="number"  id="SellBTC" class="form-control" placeholder="NGN/ETH">
									</div>
								</div>
								<div style="clear:both"></div>
