        ...
        <div class="card">
            ...
            <div class="form-group ">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control"  placeholder="Amount(BTC)" value="0.067" readonly>
                    </div>
                </div>
            </div>
            <div class="form-group ">
                <div class="row">
                    <div class="col-md-3">
                        <label class="form-label">Amount(BTCUSD)</label>
                    </div>
                    <div class="col-md-9">
                        <input type="text" class="form-control"  placeholder="Amount(BTCUSD)" value="$200" readonly>
                    </div>
                </div>
            </div>
            <div class="form-group ">
                <div class="row">
                    <div class="col-md-3">
                        <label class="form-label">Amount(BTCNGN)</label>
                    </div>
                    <div class="col-md-9">
                        <input type="text" class="form-control"  placeholder="Amount(BTCNGN)" value="N200000" readonly>
                    </div>
                </div>
            </div>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    ...
                                    <div class="">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Complete Transaction</button>
                                    </div>
                                </div>
                            </div>
