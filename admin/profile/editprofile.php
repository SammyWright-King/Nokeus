                ...
                <div class="card-content">
                    <div class="card-body">
                        <img src="https://profile.freepik.com/accounts/avatar/default_07.png?1555671037" alt="element 02"
                            class="mb-1">
                        <h3 class="card-title">Jacob Gleep</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="py-2">
                        <nav class="nav">
                            ...
                            <a class="nav-link" data-toggle="tab" href="#friends">Update password</a>
                            <a class="nav-link" data-toggle="tab" href="#timeline">Log out</a>
                        </nav>
                    </div>
                </div>
                <!-- main-profile-body -->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group ">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control"  placeholder="Account Name" value="James Job">
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control"  placeholder="Bank Name" value="GTB">
                                </div>
                            </div>
                        </div>
